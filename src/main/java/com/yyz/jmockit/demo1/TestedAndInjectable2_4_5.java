...
public class TestedAndInjectable2_4_5 {

        //@Tested修饰的类，表示是我们要测试对象,在这里表示，我想测试订单服务类。JMockit也会帮我们实例化这个测试对象
        @Tested
        OrderService2_4_4 orderService;
        //测试用户ID
        ...
        // 测试注入方式
        @Test
        public void testSubmitOrder(@Injectable MailService2_4_2 mailService,
                                    @Injectable UserCheckService2_4_3 userCheckService) {
            new Expectations() {
                {
